import { FaStar, FaEnvelope, FaHome, FaThList, FaUsers, FaPhone } from "react-icons/fa";
            ...
            <div className="flex w-10/12 m-auto max-w-6xl">
                ...
                <div className="w-72 min-h-screen bg-teal-400">
                    <ul className="menu">
                        ...
                        <>
                            <div className="mb-10 font-bold text-xl flex justify-center items-center space-x-2 py-4 underline-offset-8 underline text-red-700">
                                <FaHome></FaHome>
                                <p>Admin Home</p>
                            </div>
                            <li>
