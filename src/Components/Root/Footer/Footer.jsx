...
const Footer = () => {
    return (
        <footer className="px-4 divide-y bg-teal-500 font-semibold text-black">
            <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                <div className="lg:w-1/3">
                    <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
                        <div className="flex items-center justify-center w-3/4 m-auto rounded-full ">
                            <img src="https://assets-global.website-files.com/6153505f6048ea0c20a70140/6154a23ce3c6e550c967959e_Logo%20Tiny.svg" alt="" />
                        </div>
                    </a>
                </div>
            ...
            <div className="py-6 text-sm text-center ">© 2023 <strong>Parcel Tracker Limited,</strong> All rights reserved.</div>
        </footer>
    );
};
